...
- :math:`p (А+) = 0,85 \cdot 0,42 = 0,357`

- :math:`p (Б+) = 0,85 \cdot 0,17 = 0,1445`

- :math:`p (АБ+) = 0,85 \cdot 0,07 = 0,0595`

- :math:`p (0-) = 0,15 \cdot 0,34 = 0,051`

- :math:`p (А-) = 0,15 \cdot 0,42 = 0,063`

- :math:`p (Б-) = 0,15 \cdot 0,17 = 0,0255`

- :math:`p (АБ-) = 0,15 \cdot 0,07 = 0,0105`
...
Израчунати умножак :math:`p (А) \cdot p (Б)` и упоредити резултате.
...
- :math:`P (А ∩ Б) = P (А) \cdot P (Б)`
- Видели смо у претходном примеру да за независне догађаје вреди :math:`P (А ∩ Б)= P (А) \cdot P (Б)`. 
...
- Сада је :math:`p (Ц) = p ((А ∩ Б) ∪ (Г ∩ Д)) = p (А ∩ Б) + p (Г ∩ Д) = (\frac{8}{13} \cdot \frac{5}{13}) + (\frac{5}{13} \cdot \frac{8}{13}) = \frac{80}{169}`
...
Сада је :math:`p (А ∩ Б ∩ Ц) = p (А) \cdot p (Б) \cdot p (Ц) = \frac{3}{5} \cdot \frac{2}{3} \cdot \frac{5}{6} = \frac{1}{3}`
...
- Сва три случаја се међусобно искључују, а погодак или промашај једног од стрелаца не утиче на остала два стрелца. Сада је: :math:`p ((А ∩ Б" ∩ Ц")) ∪ ((Ā ∩ Б ∩ Ц")) ∪ ((Ā ∩ Б" ∩ Ц)) = p ((А ∩ Б" ∩ Ц")) + ((Ā ∩ Б ∩ Ц")) + ((Ā ∩ Б" ∩ Ц)) = p (А) \cdot p (Б") \cdot p (Ц") + p (Ā) ∙ p (Б) ∙ p (Ц") + p (Ā) \cdot p (Б") \cdot p (Ц) = \frac{3}{5} \cdot \frac{1}{3}$ \cdot $\frac{1}{6} + \frac{2}{5}$ \cdot \frac{2}{3} \cdot \frac{1}{6} + \frac{2}{5} \cdot \frac{1}{3} \cdot \frac{5}{6} = \frac{17}{90}`
...
:math:`p (А ∩ B ∩ Ц) = 1 - p (Ā ∩ Б" ∩ Ц") = 1 - \frac{2}{5} \cdot \frac{1}{3} \cdot \frac{1}{6} = \frac{44}{45}`
...
- :math:`p (А) \cdot p (Б) = \frac{2}{8} \cdot \frac{4}{8} = \frac{1}{8} = p (А ∩ Б)` чиме смо доказали да су догађаји А и Б независни. 
- Из :math:`Б ∩ Ц = {ЖММ, МЖМ, ММЖ}` следи :math:`p (Б) \cdot p (Ц) = \frac{4}{8} \cdot \frac{6}{8} = \frac{3}{8} = p (Б ∩ Ц)` па су и догађаји Б и Ц независни. 
- Видимо да је :math:`А ∩ Ц = {ЖЖЖ}` па је :math:`p (А) \cdot p (Ц) = \frac{2}{8} \cdot $\frac{7}{8} = \frac{7}{32}` што није :math:`p (А ∩ Ц) = \frac{1}{8}`
...
- :math:`p (А ∩ Б) = p (А) \cdot p (Б)`
- :math:`p (А ∩ Ц) = p (А) \cdot p (Ц)`
- :math:`p (Б ∩ Ц) = p (Б) \cdot p (Ц)`
- :math:`p (А ∩ Б ∩ Ц) = p (А) \cdot p (Б) \cdot p (Ц)` 
...
- :math:`p (А) =  \frac{18}{36}= $\frac{1}{2}`, :math:`p (Б) = \frac{18}{36} = \frac{1}{2}`, :math:`p (Ц) = \frac{4}{36} =  \frac{1}{9}` 
- Будући да је :math:`А ∩ Б ∩ Ц = {(3,6)}`, следи
- :math:`p (А ∩ Б ∩ Ц) = \frac{1}{36} = p (А) \cdot p (Б) \cdot p (Ц)`.
- Треба још израчунати и вероватноћу по паровима: 

- :math:`p (А ∩ Б) = \frac{9}{36} = \frac{1}{4} = p (А) \cdot p (Б)`
- :math:`p (А ∩ Ц) = \frac{1}{36} = p (А) \cdot p (Ц)`
- :math:`p (Б ∩ Ц) = \frac{1}{12} = p (Б) \cdot p (Ц)`
